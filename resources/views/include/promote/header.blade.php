<header
		...
		<div class='flex flex-wrap items-center lg:gap-y-2 gap-4 w-full'>
			<a href="{{ route('login') }}"><img src="{{asset('promote/img/logo.png')}}" alt="Smalldog Milk Tea" class='w-20 h-20' /></a>
			...
			<div id="collapseMenu"
				...
				<ul
					...
					<li class='mb-6 hidden max-lg:block'>
						<a href="index.html"><img src="{{asset('promote/img/logo.png')}}" alt="Smalldog Milk Tea" class='w-36' /></a>
					</li>
					...
					<li class='max-lg:border-b max-lg:py-3 px-3'>
						<a href="{{ route('promote.menu') }}"
							class='nav-link text-[#333] hover:text-[#007bff] text-[17px] block font-semibold {{ request()->is("menu") ? "text-[#007bff] font-bold" : "" }}'>เมนู</a>
					</li>
					<li class='max-lg:border-b max-lg:py-3 px-3'>
						<a href="{{ route('promote.contact') }}"
